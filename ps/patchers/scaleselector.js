...
(function($PS) {
  ...
  var genericScale = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Backend.Scale (line 25, column 1 - line 25, column 48): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return Kurd9.value;
      };
      ...
      return function (f) {
          return function __do() {
              ...
              return MaxForLive_Global.postLn(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "scale";
              }))(Data_Show.showRecordFieldsNil)(Backend_Scale.showScale))(Backend_Note.showNote))(Backend_Note.showNote)))(newSpec))();
          };
      };
  };
