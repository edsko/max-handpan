...
(function($PS) {
  ...
  var maxFromJust = function (v) {
      ...
      throw new Error("Failed pattern match at MaxForLive.Conversions (line 132, column 1 - line 132, column 38): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var Rendered = function (x) {
      return x;
  };
  var renderedToList = function (v) {
      return v;
  };
  var renderOne = function (note) {
  ...
  var semigroupRendered = new Data_Semigroup.Semigroup(function (a) {
      return function (b) {
          return appendMany(new Data_List_Types.Cons(a, new Data_List_Types.Cons(b, Data_List_Types.Nil.value)));
      };
  });
  exports["C"] = C;
  exports["D"] = D;
  ...
  exports["semigroupRendered"] = semigroupRendered;
  exports["toMaxRendered"] = toMaxRendered;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  ...
  var scaleNotes = function (v) {
      ...
      if (v instanceof Hijaz) {
          return [ Backend_Note.D.value, Backend_Note.Ds.value, Backend_Note.Fs.value, Backend_Note.G.value, Backend_Note.A.value, Backend_Note.As.value, Backend_Note.C.value ];
      };
      throw new Error("Failed pattern match at Backend.Scale (line 49, column 1 - line 49, column 34): " + [ v.constructor.name ]);
  };
  ...
  var genericScale = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Backend.Scale (line 28, column 1 - line 28, column 48): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return Kurd9.value;
      };
  ...
  var defaultSpec = {
      scale: Kurd9.value,
      doum: Backend_Note.D.value,
      root: Backend_Note.A.value
  };
...
(function($PS) {
  ...
  var updateSpec = function (ref) {
      return function (f) {
          return function __do() {
              var newSpec = Effect_Ref.modify(f)(ref)();
              return MaxForLive_Global.outlet(Backend_Note.toMaxRendered)(0)(Backend_Scale.renderSpec(newSpec))();
          };
      };
  };
  var setScale = function (ref) {
      return function (scale) {
          return updateSpec(ref)(function (v) {
              return {
                  scale: scale,
                  doum: v.doum,
                  root: v.root
