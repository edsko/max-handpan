...
(function($PS) {
  ...
  var maxFromJust = function (v) {
      ...
      throw new Error("Failed pattern match at MaxForLive.Conversions (line 87, column 1 - line 87, column 38): " + [ v.constructor.name ]);
  };                                                          
  ...
  exports["fromMax"] = fromMax;
  exports["maxFromJust"] = maxFromJust;
...
(function($PS) {
  ...
  var genericNote = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Backend.Note (line 24, column 1 - line 24, column 46): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var fromMaxNote = new MaxForLive_Conversions.FromMax((function () {
      var $83 = Data_Enum_Generic.genericToEnum(genericNote)(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments)))))))))))));
      var $84 = MaxForLive_Conversions.fromMax(MaxForLive_Conversions.fromMaxInt);
      return function ($85) {
          return MaxForLive_Conversions.maxFromJust($83($84($85)));
      };
  })());
...
(function($PS) {
  ...
  var genericScale = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Backend.Scale (line 26, column 1 - line 26, column 48): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return Kurd9.value;
      };
  ...
  var fromMaxScale = new MaxForLive_Conversions.FromMax((function () {
      var $8 = Data_Enum_Generic.genericToEnum(genericScale)(Data_Enum_Generic.genericBoundedEnumSum(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments))(Data_Enum_Generic.genericBoundedEnumConstructor(Data_Enum_Generic.genericBoundedEnumNoArguments)));
      var $9 = MaxForLive_Conversions.fromMax(MaxForLive_Conversions.fromMaxInt);
      return function ($10) {
          return MaxForLive_Conversions.maxFromJust($8($9($10)));
      };
  })());
