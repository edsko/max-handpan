...
(function($PS) {
  ...
  var toMaxArray = function (dictToMax) {
      return new ToMax((function () {
          var $1 = Data_Functor.map(Data_Functor.functorArray)(toMax(dictToMax));
          return function ($2) {
              return $1($2);
          };
      })());
...
(function($PS) {
  ...
  var setup = function (v) {
      return function __do() {
          ...
          MaxForLive_Global.outlet(MaxForLive_Message.toMaxMessage(MaxForLive_LiveAPI.toMaxId))(0)(new MaxForLive_Message.Message({
              messageName: "buttonMatrixId",
              messagePayload: v.value0.buttonMatrixId
          }))();
          ...
          Data_FoldableWithIndex.forWithIndex_(Effect.applicativeEffect)(Data_FoldableWithIndex.foldableWithIndexArray)(Frontend_Layout.defaultLayout.value0.tonefields)(function (ix) {
              return function (button) {
                  return function __do() {
                      v.value0.setButtonMatrixColor(button)(Frontend_Colors.defaultColors.value0.tonefield)();
                      MaxForLive_Global.postLn(Data_Show.show(Data_Show.showInt)(ix) + (": " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "col";
                      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "row";
                      }))(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Show.showInt)))(button)))();
  ...
  var main = function __do() {
      ...
      if (mPush instanceof Data_Maybe.Just) {
          ...
          return setup(mPush.value0)();
      };
      throw new Error("Failed pattern match at Frontend (line 32, column 5 - line 37, column 19): " + [ mPush.constructor.name ]);
  };
  exports["main"] = main;
})(PS);
PS["Frontend"].main();
