...
(function($PS) {
  ...
  var handleBang = function __do() {
      ...
      if (mPush instanceof Data_Maybe.Just) {
          return MaxForLive_Global.postLn("Push found!")();
      };
      throw new Error("Failed pattern match at Frontend (line 54, column 5 - line 58, column 29): " + [ mPush.constructor.name ]);
  };
