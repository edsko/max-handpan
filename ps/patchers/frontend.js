...
(function($PS) {
  ...
  var withPush = function (k) {
      return function __do() {
          var liveApp = MaxForLive_LiveAPI["new"](MaxForLive_LiveAPI.liveApp)();
          var numControlSurfaces = MaxForLive_LiveAPI.countControlSurfaces(liveApp)();
          MaxForLive_Global.postLn("numControlSurfaces: " + Data_Show.show(Data_Show.showInt)(numControlSurfaces))();
          var mPush = MaxForLive_Util.firstJustM(Effect.monadEffect)(Data_List.range(0)(numControlSurfaces - 1 | 0))(function (i) {
              return function __do() {
          ...
          throw new Error("Failed pattern match at Frontend (line 59, column 5 - line 63, column 15): " + [ mPush.constructor.name ]);
      };
  };
  var handleRelease = withPush(function (push) {
      return MaxForLive_LiveAPI.releaseControl(push)("Button_Matrix");
  });
  var handleGrab = withPush(function (push) {
      return MaxForLive_LiveAPI.grabControl(push)("Button_Matrix");
  });
