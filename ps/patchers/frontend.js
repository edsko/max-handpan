...
(function($PS) {
  ...
  var setSelected = function (v) {
      return function (selected) {
          if (selected) {
              return v.value0.grabButtonMatrix;
          };
          if (Data_Boolean.otherwise) {
              return v.value0.releaseButtonMatrix;
          };
          throw new Error("Failed pattern match at Frontend (line 78, column 1 - line 78, column 46): " + [ v.constructor.name, selected.constructor.name ]);
      };
  };
  var setup = function (v) {
      return function __do() {
          MaxForLive_Handlers.setHandler(MaxForLive_Handlers.invokeWithArg(MaxForLive_Conversions.fromMaxBoolean)(MaxForLive_Handlers.invokeNoArgs))({
              inlet: 0,
              msg: "setSelected",
              handler: setSelected(new MaxForLive_Push.Push(v.value0))
          })();
