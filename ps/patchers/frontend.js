...
(function($PS) {
  ...
  var mkPush = function (push) {
      return function __do() {
          ...
          return new Push({
              grabButtonMatrix: MaxForLive_LiveAPI.grabControl(push)(MaxForLive_LiveAPI.buttonMatrix),
              ...
              setButtonMatrixColor: function (button) {
                  return function (color) {
                      return MaxForLive_LiveAPI.setButtonMatrixColor(buttonMatrix)({
                          col: button.col,
                          row: button.row,
                          color: color
                      });
  ...
  var $$new = function __do() {
      ...
      throw new Error("Failed pattern match at MaxForLive.Push (line 29, column 5 - line 33, column 29): " + [ mPush.constructor.name ]);
  };
  exports["new"] = $$new;
})(PS);
(function($PS) {
