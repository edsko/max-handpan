      ...
      return function (b) {
          return function (c) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at MaxForLive.Push (line 58, column 5 - line 60, column 61): " + [ mMatrix.constructor.name ]);
              };
          };
      };
  };
  var releaseButtonMatrix = function (ref) {
      return MaxForLive_Push_State.withPush(ref)(function (push) {
          return MaxForLive_LiveAPI.releaseControl(push)(MaxForLive_LiveAPI.buttonMatrix);
      });
  };
...
(function($PS) {
  ...
  var setSelected = function (push) {
      return function (selected) {
          ...
          throw new Error("Failed pattern match at Frontend (line 41, column 1 - line 41, column 46): " + [ push.constructor.name, selected.constructor.name ]);
      };
  };
