...
(function($PS) {
  ...
  exports["setAutowatch"] = $foreign.setAutowatch;
})(PS);
(function(exports) {
              ...
              var go = function (v) {
                  ...
                  if (v instanceof Data_List_Types.Cons) {
                      return Control_Bind.bind(dictMonad.Bind1())(f(v.value0))(function (mb) {
                          ...
                          throw new Error("Failed pattern match at MaxForLive.Util (line 25, column 8 - line 27, column 34): " + [ mb.constructor.name ]);
                      });
                  };
                  throw new Error("Failed pattern match at MaxForLive.Util (line 21, column 5 - line 21, column 32): " + [ v.constructor.name ]);
              };
              return go(as);
          };
      };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["MaxForLive.Push.State"] = $PS["MaxForLive.Push.State"] || {};
  var exports = $PS["MaxForLive.Push.State"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var setColor = function (b) {
      return function (c) {
          return function (st) {
              return {
                  push: st.push,
                  buttonMatrix: st.buttonMatrix,
                  colors: Data_Map_Internal.insert(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                      return "row";
                  }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
                      return "col";
                  }))(Data_Ord.ordInt)))(b)(c)(st.colors)
              };
          };
      };
  };
  var init = {
      push: Data_Maybe.Nothing.value,
      buttonMatrix: Data_Maybe.Nothing.value,
      colors: Data_Map_Internal.empty
  };
  var findPush = function (k) {
      return function __do() {
          ...
          var mPush = MaxForLive_Util.firstJustM(Effect.monadEffect)(Data_List.range(0)(numCS - 1 | 0))(function (i) {
              return function __do() {
                  var controlSurface = MaxForLive_LiveAPI.withPath(MaxForLive_LiveAPI.controlSurface(i))();
                  var $5 = MaxForLive_LiveAPI.objectType(controlSurface) === "Push2";
                  if ($5) {
          ...
          if (mPush instanceof Data_Maybe.Just) {
              return k(mPush.value0)();
          };
          throw new Error("Failed pattern match at MaxForLive.Push.State (line 92, column 5 - line 94, column 26): " + [ mPush.constructor.name ]);
      };
  };
  var withPush = function (ref) {
      return function (k) {
          return function __do() {
              var mPush = Data_Functor.map(Effect.functorEffect)(function (v) {
                  return v.push;
              })(Effect_Ref.read(ref))();
              if (mPush instanceof Data_Maybe.Just) {
                  return k(mPush.value0)();
              ...
              if (mPush instanceof Data_Maybe.Nothing) {
                  return findPush(function (push) {
                      return function __do() {
                          Effect_Ref.modify_(function (v) {
                              return {
                                  push: new Data_Maybe.Just(push),
                                  buttonMatrix: v.buttonMatrix,
                                  colors: v.colors
                              };
                          })(ref)();
                          return k(push)();
              ...
              throw new Error("Failed pattern match at MaxForLive.Push.State (line 51, column 5 - line 55, column 15): " + [ mPush.constructor.name ]);
          };
      };
  };
  var withButtonMatrix = function (ref) {
      return function (k) {
          return withPush(ref)(function (push) {
              return function __do() {
                  var mMatrix = Data_Functor.map(Effect.functorEffect)(function (v) {
                      return v.buttonMatrix;
                  })(Effect_Ref.read(ref))();
                  if (mMatrix instanceof Data_Maybe.Just) {
                      return k(push)(mMatrix.value0)();
                  };
                  if (mMatrix instanceof Data_Maybe.Nothing) {
                      var matrix = MaxForLive_LiveAPI.getControl(push)(MaxForLive_LiveAPI.buttonMatrix)();
                      Effect_Ref.modify_(function (v) {
                          return {
                              buttonMatrix: new Data_Maybe.Just(matrix),
                              colors: v.colors,
                              push: v.push
                          };
                      })(ref)();
                      return k(push)(matrix)();
                  };
                  throw new Error("Failed pattern match at MaxForLive.Push.State (line 63, column 5 - line 68, column 22): " + [ mMatrix.constructor.name ]);
              };
          });
      };
  };
  exports["init"] = init;
  exports["withButtonMatrix"] = withButtonMatrix;
...
(function($PS) {
  ...
  var Effect_Ref = $PS["Effect.Ref"];
  var MaxForLive_LiveAPI = $PS["MaxForLive.LiveAPI"];
  var MaxForLive_Push_State = $PS["MaxForLive.Push.State"];                
  var withButtonMatrixId = function (ref) {
      return function (k) {
          return MaxForLive_Push_State.withButtonMatrix(ref)(function (_push) {
              return function (matrix) {
                  return k(MaxForLive_LiveAPI.id(matrix));
              };
          });
      };
  };
  var setButtonMatrixColor = function (ref) {
      return function (b) {
          return function (c) {
              return function __do() {
                  Effect_Ref.modify_(MaxForLive_Push_State.setColor(b)(c))(ref)();
                  var mMatrix = Data_Functor.map(Effect.functorEffect)(function (v) {
                      return v.buttonMatrix;
                  })(Effect_Ref.read(ref))();
                  if (mMatrix instanceof Data_Maybe.Nothing) {
                  ...
                  if (mMatrix instanceof Data_Maybe.Just) {
                      return MaxForLive_LiveAPI.setButtonMatrixColor(mMatrix.value0)(b)(c)();
                  };
                  throw new Error("Failed pattern match at MaxForLive.Push (line 73, column 5 - line 75, column 61): " + [ mMatrix.constructor.name ]);
              };
          };
      };
  };
  var releaseButtonMatrix = function (ref) {
      return function __do() {
          var mPush = Data_Functor.map(Effect.functorEffect)(function (v) {
              return v.push;
          })(Effect_Ref.read(ref))();
          ...
          if (mPush instanceof Data_Maybe.Just) {
              MaxForLive_LiveAPI.releaseControl(mPush.value0)(MaxForLive_LiveAPI.buttonMatrix)();
          ...
          throw new Error("Failed pattern match at MaxForLive.Push (line 50, column 5 - line 61, column 71): " + [ mPush.constructor.name ]);
      };
  };
  ...
  var grabButtonMatrix = function (ref) {
      return MaxForLive_Push_State.withButtonMatrix(ref)(function (push) {
          return function (matrix) {
              return function __do() {
                  MaxForLive_LiveAPI.grabControl(push)(MaxForLive_LiveAPI.buttonMatrix)();
                  return Control_Bind.bindFlipped(Effect.bindEffect)(refreshColors(matrix))(Data_Functor.map(Effect.functorEffect)(function (v) {
                      return v.colors;
                  })(Effect_Ref.read(ref)))();
              };
          };
  ...
  var $$new = function __do() {
      var ref = Effect_Ref["new"](MaxForLive_Push_State.init)();
      return {
...
(function($PS) {
  ...
  var setSelected = function (push) {
      return function (selected) {
          if (selected) {
              return activate(push);
          };
          if (Data_Boolean.otherwise) {
              return deactivate(push);
          };
          throw new Error("Failed pattern match at Frontend (line 47, column 1 - line 47, column 46): " + [ push.constructor.name, selected.constructor.name ]);
      };
  };
  var main = function __do() {
      MaxForLive_Global.setInlets(1)();
      MaxForLive_Global.setOutlets(1)();
      MaxForLive_Global.setAutowatch(0)();
      var push = MaxForLive_Push["new"]();
