  ...
  var update = function (ref) {
      return function (f) {
          return function __do() {
              ...
              return Control_Applicative.unless(Effect.applicativeEffect)(Data_List["null"](newState.tuning))(function __do() {
                  MaxForLive_Global.outlet(MaxForLive_Message.toMaxMessage(MaxForLive_Conversions.toMaxInt))(0)(new MaxForLive_Message.Message({
                      name: "size",
                      payload: Data_List.length(newState.tuning)
                  }))();
                  MaxForLive_Global.postLn(Data_Show.show(Data_List_Types.showList(Data_Show.showInt))(Retuner_State.retunings(newState)))();
                  return MaxForLive_Global.outlet(MaxForLive_Conversions.toMaxList(MaxForLive_Conversions.toMaxNumber))(0)(normalize(Retuner_State.retunings(newState)))();
              })();
          };
      };
  };
