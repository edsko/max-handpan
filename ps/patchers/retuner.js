          ...
          return function __do() {
              ...
              return Control_Applicative.unless(Effect.applicativeEffect)(Data_List["null"](newState.tuning))((function () {
                  ...
                  return function __do() {
                      ...
                      MaxForLive_Global.outlet(MaxForLive_Message.toMaxMessage(MaxForLive_Conversions.toMaxInt))(2)(new MaxForLive_Message.Message({
                          name: "size",
                          payload: Data_List.length(newState.tuning)
                      }))();
                      return MaxForLive_Global.outlet(MaxForLive_Conversions.toMaxList(MaxForLive_Conversions.toMaxNumber))(2)(normalize(retunings))();
                  };
              })())();
          };
      };
